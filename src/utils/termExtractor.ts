...
export const SCHOLARLY_CONCEPTS_REGISTRY: Record<string, ScholarlyConceptMeta> = {
  // Registry pruned to ensure project isolation.
  // Only generic academic meta-concepts are retained.
  "methodology": {
    ar: "المنهجية",
    def: "الإطار النظامي والقواعد الإجرائية التي تحكم عملية البحث والتحليل العلمي."
  },
  "theoretical framework": {
    ar: "الإطار النظري",
    def: "مجموعة المفاهيم والتعاريف والافتراضات التي تشكل الرؤية العلمية للموضوع المدروس."
  },
  "empirical evidence": {
    ar: "الأدلة التجريبية",
    def: "المعطيات والوقائع المستمدة من الملاحظة المباشرة أو التجربة الميدانية."
  }
};
