...
export default function ChatWindow({
  ...
  const starterQuestions = [
    {
      text: "هل تتفق المصادر على أثر التعليم عن بعد على درجات الطلاب؟ قارن بينها وأبرز التناقضات.",
      label: "مقارنة الدرجات والتناقضات",
    },
    {
      text: "ماذا تقول المصادر عن الجوانب النفسية والاجتماعية ومرونة التعلم الرقمي؟",
      label: "المرونة والجانب النفسي",
    },
    {
      text: "استخلص منهجية ومحددات نتائج دراسة ضمان الجودة للتعليم الرقمي.",
      label: "منهجية تقرير الجودة",
    },
  ];
