...
import { BookOpen, House, ArrowLeft, TriangleAlert, Scale, ChevronRight } from "lucide-react";
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-xs p-6 md:p-10 space-y-10 text-right" dir="rtl">
          ...
          <div className="bg-amber-50/70 border-r-4 border-amber-600 rounded-xl p-5 md:p-6 space-y-4">
            <div className="flex items-start gap-x-3 text-amber-900 font-bold text-base">
              <TriangleAlert className="w-4.5 h-4.5 text-amber-600 mt-0.5 flex-shrink-0" />
          ...
          <div className="border border-slate-200 rounded-xl p-6 bg-slate-50 space-y-4 text-left" dir="ltr">
            <div className="flex items-start gap-x-3 text-slate-900 font-bold text-base">
              <Scale className="w-4.5 h-4.5 text-slate-700 mt-0.5 flex-shrink-0" />
          ...
          <div className="space-y-4 border-t border-slate-100 pt-8">
            ...
            <p className="text-sm text-slate-600 leading-relaxed">
              جميع عناصر الواجهة والتصميم والشعارات والأكواد البرمجية الخاصة بمنصة بحث OS هي ملكية حصرية لأصحابها ومحميّة بموجب قوانين حماية الملكية الفكرية. يُرخص للمستخدم استخدام المنصة حصراً لغايات البحث والتحليل الشخصي والمهني، ويُمنع منعاً باتاً استغلال الأكواد أو محاولة عكس هندسة البرمجيات أو قرصنتها.
            </p>
          </div>
