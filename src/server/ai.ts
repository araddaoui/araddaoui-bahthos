...
// Centralized default analysis / synthesis model. All routers must import this
// constant instead of hardcoding a model string so upgrades happen in one place.
