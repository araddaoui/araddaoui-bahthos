...
"شروط صارمة لمنع التكرار والنمطية القالبية (CRITICAL UNIQENESS RULES):\n" +
"- يُحظر حظراً مطلقاً تكرار السؤال النمطي القالبي (مثل: 'ما هي القيمة المضافة من هذا المستند؟') لأكثر من وثيقة واحدة.\n" +
"- يجب أن يكون السؤال الموجه لكل وثيقة فريداً تماماً ومشتقاً من عنوانها ومضمونها العلمي ومجالها المباشر (مثل: محددات التدخل العسكري، الربط بين النظرية والممارسة، دور التحرير البشري، الحوكمة التنظيمية، التأطير الإعلامي... إلخ).\n" +
"- اكتب كل سؤال بأسلوب: `### س1: [سؤال مخصص ومحدد للوثيقة 1]؟` متبوعاً بسطر فارغ ثم `**الإجابة العلمية (ج):** [إجابة تحليلية مستفاضة تعتمد حصراً على أدلة ومحتوى الوثيقة 1]`.\n" +
