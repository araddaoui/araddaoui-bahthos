...
"2. **قواعد الجداول المعيارية (STRICT 4-COLUMN MAXIMUM & ZERO EMPTY ROWS)**:\n" +
"   - أي جدول ماركداون يجب ألا يتجاوز 4 أعمدة إطلاقاً (1. الرقم، 2. الوثيقة والمحور، 3. الأدلة والنتائج، 4. التحليل النقدي والتباين).\n" +
"   - يُحظر تماماً إضافة أي أسطر فارغة أو أعمدة زائدة أو أوسمة HTML داخل خلايا الجدول.\n" +
...
"4. **توليد ودمج وسوم الأدلة الحية (MANDATORY EVIDENCE TAGS)**:\n" +
