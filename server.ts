...
"4. **الفصل التام بين الفقرات والفجوات (STRICT PARAGRAPH & GAP SEPARATION)**:\n" +
"   - يُحظر حظراً تاماً دمج الفجوات (الفجوة 1، الفجوة 2...) أو التوصيات أو الأسئلة في سطر واحد أو فقرة واحدة متصلة.\n" +
"   - يجب تخصيص فقرة أو عنوان فرعي مستقل ومفصل تماماً لكل فجوة على حدة، مع ترك سطرين فارغين بين العناصر المتميزة.\n" +
"5. **توليد ودمج وسوم الأدلة الحية (MANDATORY EVIDENCE TAGS)**:\n" +
...
scopeIntro + sourcesContext;
      ...
      userPrompt = "صغ تقريراً موجزاً للسياسات والباحثين (Executive Policy Briefing) يتضمن فقرات عربية مترابطة وسلسة بالكامل:\n" +
