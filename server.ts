...
"1. **اللغة العربية الفصحى الصافية والدقة اللغوية (PURE ARABIC & STRICT GRAMMAR)**:\n" +
"   - اكتب بلغة عربية فصيحة سليمة مع مراعاة قواعد المطابقة بين المذكر والمؤنث (مثل: \"قراءة نقدية\"، \"دراسة مستقبلية\").\n" +
"   - أنهِ كل جملة بنقطة كاملة (`.`) قبل الانتقال للنقطة التالية لمنع تداخل الجمل دون علامات ترقيم.\n" +
"   - عند ذكر عناوين الوثائق الأجنبية، ضع العنوان دائماً بين علامتي تنصيص مثل `\"Title\"` لتفادي انعكاس الأقواس والرموز.\n" +
"2. **منع التكرار اللفظي والقوالب النمطية (ZERO REPETITIVE BOILERPLATE)**:\n" +
"   - يُحظر حظراً تاماً تكرار الجمل القالبية (مثل \"اعتماد نتائج دراسة... لتحديث معايير الجودة والإجراءات التشغيلية...\").\n" +
...
"   - يجب ألا تترك أي توصية أو نقطة معلقة دون شرح واستدلال. يجب أن تشتمل كل توصية على: (أ) الدليل/النتيجة العلمية من الوثيقة، (ب) الإجراء التنفيذي الميداني الدقيق، و(ج) الأثر المرجو أو الضابط لضمان الجودة.\n" +
